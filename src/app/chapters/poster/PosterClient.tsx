    ...
    <div className="min-h-screen bg-slate-900 flex flex-col items-center py-10 px-4 text-slate-900 font-sans">
      ...
      <div className="mb-6 w-full max-w-[800px] flex justify-between items-center no-print">
        ...
        <button
          ...
          className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs px-5 py-2.5 rounded-full transition-all flex items-center space-x-2 cursor-pointer shadow-lg shadow-emerald-950/20"
        >
